  ...
  return (
    ...
    >
      <Link to={`/reader/script/${script._id}`} className="group block">
        <div className="bg-white rounded-xl border border-gray-100/80 overflow-hidden transition-all duration-300 hover:shadow-lg hover:shadow-gray-200/50 hover:border-gray-200">
          {/* Cover */}
          ...
          <div className="p-3.5">
            <div className="flex items-center gap-2 mb-1.5">
              {script.creator?.profileImage ? (
                ...
                <div className="w-4.5 h-4.5 rounded-full bg-gray-100 flex items-center justify-center text-[9px] font-medium text-gray-400">
            ...
            <h3 className="font-semibold text-gray-800 text-sm leading-snug mb-1 line-clamp-2 group-hover:text-[#1e3a5f] transition-colors">
              {script.title}
            </h3>
            {script.logline && (
              <p className="text-xs text-gray-400 line-clamp-2 mb-2 font-normal leading-relaxed">{script.logline}</p>
            )}
            <div className="flex items-center justify-between mt-1.5 pt-2 border-t border-gray-50">
              ...
              {script.genre && (
                <span className="text-[10px] px-2 py-0.5 bg-gray-50 rounded-full text-gray-400 font-medium border border-gray-100">{script.genre}</span>
              )}
            </div>
          </div>
        </div>
