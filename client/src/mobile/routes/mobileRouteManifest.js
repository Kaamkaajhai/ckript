...
export const MOBILE_ROUTE_DISPOSITIONS = Object.freeze([
  ...
  migration("accept-invite", "/invite/:token"),
  {
    ...
    reason: "The signed-out public profile uses the sanitized public projection (D34), authenticated visitors use the relationship-aware profile (D35), and the account owner gets the native workspace/editor (D36).",
    protection: "public",
    visitorOnly: true,
  ...
  migration("messages", "/messages"),
  {
    ...
    pattern: "/profile/:id?",
    disposition: MOBILE_ROUTE_DISPOSITION.SCREEN,
    reason: "Authenticated visitor profile plus the native own-profile workspace/editor; account and security settings remain an explicit desktop boundary (plan §11 Phase 5, D36).",
    protection: "authenticated",
    visitorOnly: true,
    screenId: "profile-visitor",
    ownScreenId: "profile-owner",
    shell: MOBILE_SHELL_MODE.STANDARD,
    excludeQuery: { tab: "settings" },
    excludeReason: "account-security-desktop-boundary",
    fallbackDisposition: MOBILE_ROUTE_DISPOSITION.DESKTOP_MIGRATION_FALLBACK,
  },
  /*
  ...
  },
  {
    ...
    pattern: "/:id",
    disposition: MOBILE_ROUTE_DISPOSITION.SCREEN,
    reason: "The authenticated canonical username form selects the D35 visitor profile or D36 owner workspace. Signed-out referral/profile branching remains owned by App.jsx.",
    protection: "authenticated",
    visitorOnly: true,
    screenId: "profile-visitor",
    ownScreenId: "profile-owner",
