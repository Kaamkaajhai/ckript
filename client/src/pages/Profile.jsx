    ...
    <ProfileRoot {...(isWriterUser
      ...
      {activeTab === "settings" && isOwnProfile && (
        <Motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.2 }} className={isWriterUser ? "profile-workspace-panel profile-workspace-settings" : `rounded-3xl border ${t.card} p-5 sm:p-8 flex flex-col divide-y ${dark ? "divide-white/[0.06]" : "divide-gray-100"}`}>
          ...
          {isWriterUser && (
            <div className="profile-workspace-settings__section profile-workspace-settings__section--referral py-6 first:pt-0 last:pb-0">
            <SectionCard
              dark={dark} noBox
              title="Referral"
            ...
            >
              <div className={`profile-workspace-settings__referral-body rounded-3xl border ${t.card} p-5 sm:p-8 flex flex-col divide-y ${dark ? "divide-white/[0.06]" : "divide-gray-100"}`}>
