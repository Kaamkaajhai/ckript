...
const ScriptUpload = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!isContentOnlyEditMode && !validateStep(5)) return;

    // Check credits before submitting
    const creditsNeeded = isContentOnlyEditMode ? 0 : calculateTotal();
    if (!isContentOnlyEditMode && creditsNeeded > creditsBalance) {
