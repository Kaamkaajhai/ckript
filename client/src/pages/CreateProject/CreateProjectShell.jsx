        ...
        <div className="ckcp-main" style={{ flex: "1", minWidth: 0, display: "flex", flexDirection: "column", background: dark ? "#0f0f0f" : "#ffffff" }}>
          ...
          {(creationBlocked || error) && (
            <div style={{ flex: "none", padding: "12px 16px 0" }}>
              ...
              {error && (
                <div className={`ckcp-fade ${creationBlocked ? "mt-3 " : ""}px-4 py-3 border rounded-xl text-sm flex flex-wrap items-center justify-between gap-2 ${dark ? "bg-red-500/10 border-red-500/20 text-red-400" : "bg-red-50 border-red-200 text-red-700"}`}>
